package com.blucor.tcthecontractor.project.sub_contractor.fragments;
 ...
 */
public class SubCBillingFragment extends Fragment {
    ...
    public SubCBillingFragment() {
        // Required empty public constructor
    }

    public SubCBillingFragment(float total_work_order_amount, ArrayList<BilliModel> bills, ProjectsModel selected_project,SubContractor selected_sub_contractor) {
        this.total_work_order_amount = total_work_order_amount;
        this.bills = bills;
        this.selected_project = selected_project;
        this.selected_sub_contractor = selected_sub_contractor;
    }
