...
public class TodaysActivityExpandableListViewAdapter extends BaseExpandableListAdapter {
    private Context context;
    private List<ActivityResponseModel> activityResponses;

    public TodaysActivityExpandableListViewAdapter(Context context, List<ActivityResponseModel> activityResponses) {
