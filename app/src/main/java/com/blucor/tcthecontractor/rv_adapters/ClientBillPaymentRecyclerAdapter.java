...
public class ClientBillPaymentRecyclerAdapter extends BaseAdapter {
    private List mList;
    private final Context mContext;
    private ViewHolder viewHolder;
    private RecyclerViewClickListener mListener;

    public ClientBillPaymentRecyclerAdapter(Context mContext, List mList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = LayoutInflater.from(mContext).inflate(R.layout.client_billing_payment_list_item, null);
    ...
    public class ViewHolder {
        ...
        ViewHolder(final View itemView) {
            ...
            tv_payment_date = itemView.findViewById(R.id.tv_pd_billing_date_billing_list_item);
