...
public class ClientProjectActivityModel {
    private String no;
     ...
     * @param editFlag
     */
    public ClientProjectActivityModel(String no, String activityName, String startDate, String endDate, String duration, String workerName, String workerMobileNo, boolean editFlag) {
        this.no = no;
     ...
     * @param editFlag
     */
    public ClientProjectActivityModel(boolean editFlag) {
        this.editFlag = editFlag;
    }
